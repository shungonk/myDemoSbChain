...
public class PurchaseRequestTest {
    ...
    public void getData() throws Exception {
        var input = new PurchaseRequest("address", BigDecimal.ONE, 1614908880604L);
        var expected = ("address11614908880604").getBytes();
    ...
    public void validateAmount_False_Zero() throws Exception {
        var input = new PurchaseRequest("address", BigDecimal.ZERO, 1614908880604L);
        assertThat(input.validateAmount(), is(false));
    }

    @Test
    public void validateAmount_False_Negative() throws Exception {
        var input = new PurchaseRequest("address", BigDecimal.ONE.negate(), 1614908880604L);
        assertThat(input.validateAmount(), is(false));
    }
    ...
    public void verifyAddress_True() throws Exception {
        ...
        var input = new PurchaseRequest(adr, BigDecimal.ONE, 1614908880604L);
        input.signate(pvt, pub);
    ...
    public void verifyAddress_False_InvalidAddress() throws Exception {
        var input = new PurchaseRequest("swindlerAdr", BigDecimal.ONE, 1614908880604L);
        input.signate(pvt, pub);
    ...
    public void verifySignature_False_DataReplaced() throws Exception {
        ...
        var jsonReplaced = json.replace("address", "swindlerAdr");
        var inputReplaced = StringUtil.fromJson(jsonReplaced, PurchaseRequest.class);
